...
const LoanDocument = ({ toggleDropdown, isOpen, stage, setStage }: any) => {
            ...
            {isLoading ? (
                ...
                <div className="grid gap-[20px] md:w-[842px] h-screen overflow-y-scroll">
                    <div style={{ marginTop: '20px' }}>
                        <p className="text-[20px] font-bold">Dear {userName},</p> <br />
                        ...
                        <ol style={{ fontSize: 'small' }} className="space-y-4 text-gray-900 list-decimal list-inside ">
                            {userName}: an adult and a resident of Nigeria with an account at Build Microfinance Bank Limited (hereinafter referred to as the "Borrower" which expression shall, where the context admits, include the Borrower's heirs, successors, assigns, and personal representatives) of the first part
                            ...
                            <div className="flex items-center mb-4 cursor-pointer">
                                <input id="default-checkbox" type="checkbox" value={checked} onChange={(e: any) => setChecked(e?.target?.checked)} className="hidden" />
                                <label htmlFor="default-checkbox" className="relative flex items-center cursor-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div className={`${checked === true ? 'invisible' : 'visible'}`} style={{ marginLeft: '300px', cursor: 'pointer' }}>
                        {/* <Button title="Accept Loan" onClick={handleSubmit} isLoading={isLoading} /> */}
                        <span className="mx-6">
                            <button type="button" className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-lime-500 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                Download File
                            </button>
                        </span>
                        <img src={Image.downloadFile} width={200} />
                    </div>
