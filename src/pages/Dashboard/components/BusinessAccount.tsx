        ...
        <div className="rounded-lg bg-[#F9F9F9] py-[12px] px-[20px] grid gap-[10px] h-fit">
            ...
            <div className="grid gap-1">
                ...
                <p className="text-[30px] text-[#121212]">
                    {accountNumber || accountNum || "N/A"} {/* Display "N/A" if no account number is available */}
                </p>
            </div>
            <div className="grid gap-1">
            ...
            <div className="grid gap-1">
                ...
                <p className="text-[15px] text-[#121212]">{settlementBank || "Merchant Bank"}</p> {/* Default to "Merchant Bank" */}
            </div>
