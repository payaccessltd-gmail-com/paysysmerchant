...
import AccountDetails from "../../Dashboard/components/AccountDetails";
import { Button } from "../../../components/reusables/DefaultButton";
import RecentTransaction from "../../Dashboard/components/RecentTransaxtion";
import BusinessAccount from "../../Dashboard/components/BusinessAccount";
import PaymentChannel from "../../Dashboard/components/PaymentChannel";
import BranchPerformance from "../../Dashboard/components/BranchPerfomance";
...
import Graph from "../../../components/inventory/components/graph";
  ...
  return (
    ...
    <>
     ...
     {loading ? (
        ...
        <>
         <div className="bg-[#E3ECFF] grid md:grid-cols-[2fr_1fr] p-[20px] gap-[20px]">
