...
import { repayAllLoans } from "../../containers/loanApis";

const RepayAllLoansModal = ({ toggleDropdown, isOpen, stage, setStage }: any) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        repayAllLoans(location?.state?.id).then((response: any) => {
            setShowErrMsg(null)
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="bg-white p-8 rounded-lg z-10">

                        {
                            showErrMsg === false ?
                                <>
                                    <p className="text-lg font-semibold mb-4 ml-12">Are you sure you want to repay all loans?</p>
...
export default RepayAllLoansModal;
